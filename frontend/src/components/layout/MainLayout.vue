<template>
  <div class="flex h-screen bg-background text-slate-900 overflow-hidden">
    ...
    >
      <!-- Logo Area -->
      <div class="flex items-center gap-3 px-6 h-16 border-b border-slate-100 mb-2">
        <div class="w-8 h-8 rounded-lg bg-primary-600 flex items-center justify-center text-white font-bold shadow-soft">
          <Package2Icon class="w-5 h-5" />
        </div>
        <span class="text-sm font-bold tracking-tight text-slate-800 uppercase">BranchOS Cloud</span>
      </div>

      <!-- Nav Sections -->
      <nav class="flex-1 overflow-y-auto px-4 py-4 space-y-6">
        <div>
          <h3 class="px-2 mb-2 text-[10px] uppercase font-bold text-slate-400 tracking-widest">Main Menu</h3>
          <div class="space-y-1">
        ...
        <div>
          <h3 class="px-2 mb-2 text-[10px] uppercase font-bold text-slate-400 tracking-widest">Enterprise</h3>
          <div class="space-y-1">
      ...
      <div class="p-4 border-t border-slate-100 bg-slate-50/50">
        <div class="flex items-center gap-3 px-2 py-0.5">
          <div class="w-8 h-8 rounded-full bg-slate-200 border border-slate-300 flex items-center justify-center text-xs font-semibold text-slate-600">
            JD
          </div>
